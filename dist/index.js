...
var IFrameIntegrationButton = function (_a) {
    ...
    return (jsxRuntime.jsxs("form", __assign({ method: "post", action: postUrl, id: "formAuthorizeNetPopup", name: "formAuthorizeNetPopup", target: "iframeAuthorizeNet", onSubmit: handleShowPopup }, { children: [jsxRuntime.jsx("input", { type: "hidden", id: "popupToken", name: "token", value: formToken }), jsxRuntime.jsx("button", __assign({ disabled: popupIsShown, className: className }, { children: children }))] })));
};
